    ...
    <div className="ptext">
      <div className="projectinfo">
        <div className="about">
          ...
          <h2>The GeneX Project is a unique and rare 3D NFT collection of 4444 NFTs created by randomly generating over 200 traits. The collection is based on the Ethereum blockchain and includes 4444 unique GeneX.</h2>
          <ReactTypingEffect
