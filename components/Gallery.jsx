  ...
  return (
    <div id="gallery" className="relative py-20 bg-primary">
      ...
      <Carousel variant="dark" breakPoints={breakPoints}>
        <a href='https://twitter.com/shintalha' target="_blank">
          <div className="item">
        ...
        <a href='https://www.instagram.com/serkan.demirs/' target="_blank">
          <div className="item">
        ...
        <a href='https://www.artstation.com/re1mon' target="_blank">
          <div className="item">
